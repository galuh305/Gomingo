$(function () {
  ...
  var elChart = document.querySelector("#chart");
  if (elChart) {
    var chart = new ApexCharts(elChart, chartOptions);
    chart.render();
  }
  ...
  var elBreakup = document.querySelector("#breakup");
  if (elBreakup) {
    var chartBreakup = new ApexCharts(elBreakup, breakup);
    chartBreakup.render();
  }
  ...
  var elEarning = document.querySelector("#earning");
  if (elEarning) {
    new ApexCharts(elEarning, earning).render();
  }
});